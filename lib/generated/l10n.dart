...
class S {
  ...
  String weFoundProducts(dynamic length) {
    return Intl.message(
  ...
  String addToCartSucessfully(dynamic name) {
    return Intl.message(
      '$name have been added to your cart',
...
class AppLocalizationDelegate extends LocalizationsDelegate<S> {
  ...
  List<Locale> get supportedLocales {
    return const <Locale>[
      Locale.fromSubtags(languageCode: 'ar'), Locale.fromSubtags(languageCode: 'en'), Locale.fromSubtags(languageCode: 'es'), Locale.fromSubtags(languageCode: 'ja'), Locale.fromSubtags(languageCode: 'vi'), Locale.fromSubtags(languageCode: 'zh'),
    ];
  }
