...
class _BackdropState extends State<Backdrop> with SingleTickerProviderStateMixin {
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    const double layerTitleHeight = 0;
  ...
  PopupMenuItem<String> _buildMenuItem(IconData icon, String label, String value, [bool isSelect = false]) {
    final TextStyle menuItemStyle =
        TextStyle(
          fontSize: 13.0, 
          color: isSelect ? Theme.of(context).primaryColor : Theme.of(context).accentColor, 
          height: 24.0 / 15.0,
        );
      ...
      child: Row(
        children: <Widget>[
          Padding(
            ...
            child: Icon(icon, color: isSelect ? Theme.of(context).primaryColor : Theme.of(context).accentColor, size: 17),
          ),
    ...
    var appBar = AppBar(
      ...
      bottom: widget.appbarCategory != null
          ? PreferredSize(
              ...
              child: AnimatedOpacity(
                ...
                child: BottomAppBar(elevation: 0.0, child: widget.appbarCategory),
              ),
            )
          : null,
      ...
      actions: <Widget>[
        PopupMenuButton<String>(
          icon: Icon(FontAwesomeIcons.sort, color: Colors.white, size: 18),
          onSelected: (String item) {
            _selectSort = item;
            widget.onSort(item);
          },
          itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
            _buildMenuItem(FontAwesomeIcons.calendarAlt, 'Date', "date", _selectSort == "date"),
            _buildMenuItem(FontAwesomeIcons.star, 'Featured', "featured", _selectSort == "featured"),
            _buildMenuItem(FontAwesomeIcons.percentage, 'On Sale', "on_sale", _selectSort == "on_sale"),
          ],
        ),
        IconButton(
            icon: AnimatedIcon(
