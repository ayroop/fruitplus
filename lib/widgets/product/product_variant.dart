...
class BasicSelection extends StatelessWidget {
  ...
  BasicSelection(
      {@required this.options, @required this.title, @required this.value, this.type, this.layout, this.onChanged});
              ...
              Container(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: type == "color"
                      ? BoxDecoration(
                          color: item == value
                              ? HexColor(kColorNameToHex[item.toLowerCase()] ?? "#ffffff")
                              : HexColor(kColorNameToHex[item.toLowerCase()] ?? "#ffffff").withOpacity(0.6),
                      ...
                      : BoxDecoration(
                          color: item == value ? primaryColor : Colors.transparent,
                        ...
                        : Container(
                            ...
                            child: Padding(
                              child: Text(
                                item,
                                style: TextStyle(
                                  color: item == value ? Colors.white : Theme.of(context).accentColor,
                                  fontSize: 14,
                                ),
                              ),
...
class OptionSelection extends StatelessWidget {
  ...
  OptionSelection({@required this.options, @required this.value, this.title, this.layout, this.onChanged});
...
class ColorSelection extends StatelessWidget {
  ...
  ColorSelection({@required this.options, @required this.value, this.layout, this.onChanged});
  ...
  Widget build(BuildContext context) {
    if (layout == VariantLayout.dropdown) {
      return GestureDetector(
        onTap: () => showOptions(context),
        child: Container(
          decoration: BoxDecoration(border: Border.all(width: 1.0, color: kGrey200)),
          height: 42,
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(
                  child: Text(S.of(context).color, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                ),
                Container(
                    height: 20,
                    width: 20,
              ...
              AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: item == value
                        ...
                        : HexColor(kColorNameToHex[item.toLowerCase()]).withOpacity(0.6),
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                      for (int option = 1; option <= limitSelectQuantity; option++)
                        ListTile(
                            onTap: () {
                              onChanged(option);
                              Navigator.pop(context);
